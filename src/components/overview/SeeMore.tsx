...
export default function SeeMore({ section, action, width }: CardProps) {
  return (
    <div
      className={`flex flex-row justify-between items-center w-[303px] md:w-[620px] xxl:w-[680px] h-[24px] gap-6 mx-auto bg-white ${width} `}
    >
