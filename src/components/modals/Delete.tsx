...
export default function Delete({
  ...
  return (
    <div className="p-[24px_20px] flex flex-col gap-5 w-[335px] md:w-[560px] h-[300px] bg-white rounded-[12px] mx-auto fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] shadow-lg z-50">
      ...
      <button
        className="flex flex-row items-center justify-center p-4 gap-4 w-[295px] h-[53px] bg-[#C94736] rounded-[8px] md:w-[520px]"
        onClick={onConfirm}
      >
      ...
      <button
        className="flex flex-row items-center justify-center p-4 gap-4 w-[295px] h-[53px] bg-[#F8F4F0] rounded-[8px] md:w-[520px]"
        onClick={onCancel}
      >
