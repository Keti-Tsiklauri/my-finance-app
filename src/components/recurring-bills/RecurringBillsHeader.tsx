...
export default function RecurringBillsHeader() {
  return (
    <div className="hidden xxl:pt-0  mx-auto md:flex flex-row items-center py-[12px] gap-[32px] w-[700px] h-[42px] border-b border-[#F2F2F2] self-stretch order-1 flex-none box-border">
      {/* Recipient / Sender */}
